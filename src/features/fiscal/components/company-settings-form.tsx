  ...
  return (
    ...
    >
      <div className="space-y-2">
        ...
        <div className="inline-flex grow bg-card border rounded-xl p-4 sticky bottom-4 left-4 w-full mt-2 gap-2 shadow-lg shadow-slate-950/5 dark:shadow-black/25">
