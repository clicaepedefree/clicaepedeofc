...
import { Banknote, ChevronLeft, CreditCard } from 'lucide-react'
...
export const PosPayments = ({ onClose }: { onClose: () => void }) => {
  return (
    <TabsWithIcons
      className="bg-white w-full h-full rounded-xl border"
      headerClassName=" bg-bottom"
      triggerClassName="[&>svg]:h-7 [&>svg]:w-7 "
      tabs={paymentTabs}
    >
      <TabsContent value={'cash'}>Dinheiro</TabsContent>
