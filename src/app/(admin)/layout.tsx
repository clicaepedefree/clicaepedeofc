...
const adminMenuItems = [
  {
    ...
    requiredPermission: 'reports.view' as const,
  },
  {
    ...
    items: [
      {
        ...
        requiredPermission: 'menu.manage' as const,
      },
      {
        title: 'Cardapio Digital',
        url: '/digital-menu',
        icon: 'store' as const,
        requiredPermission: 'store.settings.manage' as const,
      },
      {
        title: 'Configurações',
        url: '/settings/store',
    ...
    items: [
      {
        ...
        requiredPermission: 'pos.operate' as const,
      },
      {
        title: 'Pedidos',
        url: '/orders',
        icon: 'shopping-cart' as const,
        requiredPermission: 'orders.manage' as const,
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        url: '/invoices',
        icon: 'files' as const,
        requiredPermission: 'fiscal.manage' as const,
      },
      {
        title: 'Configurações',
        url: '/settings/fiscal',
...
export default async function AdminLayout({
  ...
  const internalOperationHref = canAccessInternalOperations({ operator })
    ? '/internal-operations'
    : undefined
