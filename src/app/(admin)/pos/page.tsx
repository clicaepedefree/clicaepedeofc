...
import { addItemToCartAtom } from '@/features/catalog/state'
...
export default function Page() {
  ...
  return (
    <div className="col-span-2 flex flex-col items-start gap-2 overflow-y-scroll h-full">
      ...
      <div className="grid grid-cols-[2fr_1fr] w-full gap-6 h-[inherit] items-start overflow-y-hidden">
