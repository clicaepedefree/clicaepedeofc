                ...
                <div className="flex justify-between items-center w-full">
                  ...
                  <div className="flex items-center justify-between">
                    <div
                      ...
                      aria-label={`Limpar ${selectedValues.length} opções selecionadas`}
            ...
            <Command>
              {searchable && (
                <CommandInput
                  ...
                  aria-label="Busque pelas opções disponíveis"
                      ...
                      {group.options.map(option => {
                        ...
                        return (
                          <CommandItem
                            ...
                            className={cn(
                              'cursor-pointer',
                              option.disabled && 'opacity-0 cursor-not-allowed'
                            )}
